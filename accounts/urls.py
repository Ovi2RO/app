...
from .views import landing_view, SignOutView, UserSigninView, UserSignupView
"""
...
urlpatterns = [
    ...
    path('allauth/signin/', UserSigninView.as_view(), name='account_login'),
    path('allauth/signup/', UserSignupView.as_view(), name='account_signup'),
]
